...
class MainActivity : AppCompatActivity() {
    ...
    fun startLocation() {
        GiPStech.getIndoorLocalizer().selectFloor("id of the floor", object: ProgressCallback<Void?> {
            override fun onResult(result: Void?) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GiPStech.init(this, "insert the development key associated to your app")
